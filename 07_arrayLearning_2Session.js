...
let arrayOfNumbers = [1, 2, 30, 20, 40];
let lastIndex = arrayOfNumbers.length - 1;
for (let index = lastIndex; index >= 0; index--) {
    const element = arrayOfNumbers[index];
    console.log(element); 
}
console.log(`======== Array of salaries =========`);
...
var arrayOfNum = [4, 5, 6, 8, 9, 1];
console.log(arrayOfNum);
arrayOfNum.unshift(77);// adding element in the first/start.
arrayOfNum.unshift(99, 111, 333);
console.log(arrayOfNum);

console.log(`======== pop() methods=========`);
var arrayOfNum = [4, 5, 6, 8, 9, 33];
let popResult = arrayOfNum.pop(); // remove element in the last.
console.log(popResult);
console.log(arrayOfNum);

console.log(`======== shift() methods=========`);
var arrayOfNum = [4, 5, 6, 8, 9, 33];
let shiftResult = arrayOfNum.shift();// remove element in the first/start.
...
console.log("====== Inserting element in the array (using Splice Method) =======");
var arrayOfNum = [4, 5, 6, 8, 9, 33, 66];
console.log(arrayOfNum);
...
console.log("====== Replacing element in the array (using Splice Method) =======");
var arrayOfNum = [4, 5, 6, 8, 9, 33, 66];
console.log(arrayOfNum);
