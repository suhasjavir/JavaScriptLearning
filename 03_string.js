...
console.log("Character at the last index is:", javaScript.charAt(totalChar - 1));
console.log("First character in the given string is:", javaScript.charAt(0));
console.log("Length of the string is:", javaScript.length, "&", "Square of the total charcter length is:", totalChar * totalChar);
console.log("--------------------------------------------------------------------------");