...
console.log(`The given String Length of "javascript" is Odd Or Even : ${wordEvenOrOdd("javascript")}`);
console.log(`The given String Length of "developer" is Odd Or Even : ${wordEvenOrOdd("developer")}`);
console.log(`The given String Length of "google" is Odd Or Even : ${wordEvenOrOdd("google")}`);
