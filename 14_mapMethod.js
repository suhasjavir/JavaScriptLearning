...
const arrayOfSquare1 =arrayOfNumber.map(currentValue =>  currentValue * currentValue); //map transform in one line code instead of two line. (reduce code)
console.log(arrayOfSquare);
...
// array updating with adding its index no
